...
public class ParameterCheckAspect {
     ...
     * 防止XSS攻击
     */
    @Pointcut("execution(* com.tcjn.controller..*(..))  ")
    public void preventXSS() {
    }
    /**
     * Log注解
     */
    @Pointcut("@annotation(com.haier.datamart.annotation.Log)")
    public void recordLog(){
    }
    /**
     * 验证参数
     */
    @Pointcut("@annotation(com.haier.datamart.annotation.ValidationParam)")
