...
/**
 * <p>hacResourceDTO complex type的 Java 类。
 * 
 * <p>以下模式片段指定包含在此类中的预期内容。
 * 
 * <pre>
 * &lt;complexType name="hacResourceDTO"&gt;
 *   &lt;complexContent&gt;
 ...
 *         &lt;element name="childResources" type="{http://service.resource.hac.openplatform.haier.com/}hacResourceDTO" maxOccurs="unbounded" minOccurs="0"/&gt;
...
@XmlType(name = "hacResourceDTO", propOrder = {
    "appCode",
    "appConfiguration",
    "appId",
    "appName",
    ...
    extends HacBaseDTO
{
    ...
    protected List<HacResourceDTO> childResources;
    ...
    /**
     * Gets the value of the childResources property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the childResources property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getChildResources().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     * 
     */
    public List<HacResourceDTO> getChildResources() {
        if (childResources == null) {
            childResources = new ArrayList<HacResourceDTO>();
        }
